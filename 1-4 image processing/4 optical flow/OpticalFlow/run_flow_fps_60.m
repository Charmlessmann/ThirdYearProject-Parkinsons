%% This script is for computing the optical flow of each video sample - FPS 60(Using all the frames)
...
save_file = fullfile(save_dir, 'OC01_L.mat');
...
parfor i = 1: n-1
    ...
    the_result(i) = magnitude;
    disp(i)
end

save(save_file,'the_result');
