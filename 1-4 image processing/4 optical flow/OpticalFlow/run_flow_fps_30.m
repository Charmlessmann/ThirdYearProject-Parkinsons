%% This script is for computing the optical flow of each video sample - FPS 30(Using all the frames)
...
save_file = fullfile(save_dir, 'OC01_L_fps_30.mat');
...
%fps 30
n = round(n/2);
the_result_30 = zeros(1,n);

parfor i = 1: n-1
    
    %fps: 30
    % compute the optical flow using frames 1,3 and 3,5 and 5,7 and ...
    a = 2*i-1;
    b = 2*(i+1)-1;
    ...
    the_result_30(i) = magnitude;
    disp(i)
end
save(save_file,'the_result_30');
