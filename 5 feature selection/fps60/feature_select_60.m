...
% The inputs are composed from the optical flow results - 60 PFS
...
test_power = [];
 ...
 for  i = 1:n
        ...
        %3.)percentage power
        prc_power = [sum(Y2(1:50)) sum(Y2(51:100)) sum(Y2(101:150)) sum(Y2(151:200)) sum(Y2(201:250)) sum(Y2(251:300))];
        prc_power = prc_power/total_power;
        test_power = [test_power; sum(Y2(1:300))/sum(Y2(1:480))];
