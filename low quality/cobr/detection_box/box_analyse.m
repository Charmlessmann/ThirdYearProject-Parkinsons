...
main_path = 'E:\Parkinson\3yp_parkinson\lowquality\cobr\detection_box\patients\23\R\';
number_path = 'P23_R_';
...
group_01 = reshape_box_arr(cell2mat(struct2cell(load([main_path, number_path, '01.mat']))));
group_02 = reshape_box_arr(cell2mat(struct2cell(load([main_path, number_path, '02.mat']))));
group_03 = reshape_box_arr(cell2mat(struct2cell(load([main_path, number_path, '03.mat']))));
group_04 = reshape_box_arr(cell2mat(struct2cell(load([main_path, number_path, '04.mat']))));

%%
x_lengths_original = zeros(1,4);
x_lengths_01 = zeros(1,4);
x_lengths_02 = zeros(1,4);
x_lengths_03 = zeros(1,4);
x_lengths_04 = zeros(1,4);

% calculate the x lengths of detection box of each frames.
for i = 1:4
    x_lengths_original(1,i) = orginal(i,2) - orginal(i,1);
    x_lengths_01(1,i) = group_01(i,2) - group_01(i,1);
    x_lengths_02(1,i) = group_02(i,2) - group_02(i,1);
    x_lengths_03(1,i) = group_03(i,2) - group_03(i,1);
    x_lengths_04(1,i) = group_04(i,2) - group_04(i,1);
end
x_lengths = cat(1,x_lengths_original,x_lengths_01,x_lengths_02,x_lengths_03,x_lengths_04);

%%
y_lengths_original = zeros(1,4);
y_lengths_01 = zeros(1,4);
y_lengths_02 = zeros(1,4);
y_lengths_03 = zeros(1,4);
y_lengths_04 = zeros(1,4);

% calculate the y lengths of detection box of each frames.
for i = 1:4
    y_lengths_original(1,i) = orginal(i,4) - orginal(i,3);
    y_lengths_01(1,i) = group_01(i,4) - group_01(i,3);
    y_lengths_02(1,i) = group_02(i,4) - group_02(i,3);
    y_lengths_03(1,i) = group_03(i,4) - group_03(i,3);
    y_lengths_04(1,i) = group_04(i,4) - group_04(i,3);
end
y_lengths = cat(1,y_lengths_original,y_lengths_01,y_lengths_02,y_lengths_03,y_lengths_04);

%%
x_mid_point_original = zeros(1,4);
x_mid_point_01 = zeros(1,4);
x_mid_point_02 = zeros(1,4);
x_mid_point_03 = zeros(1,4);
x_mid_point_04 = zeros(1,4);

% calculate the x mid point of detection box of each frames.
for i = 1:4
    x_mid_point_original(1,i) = (orginal(i,2) + orginal(i,1))/2;
    x_mid_point_01(1,i) = (group_01(i,2) + group_01(i,1))/2;
    x_mid_point_02(1,i) = (group_02(i,2) + group_02(i,1))/2;
    x_mid_point_03(1,i) = (group_03(i,2) + group_03(i,1))/2;
    x_mid_point_04(1,i) = (group_04(i,2) + group_04(i,1))/2;
end
x_mid_points = cat(1,x_mid_point_original,x_mid_point_01,x_mid_point_02,x_mid_point_03,x_mid_point_04);

%%
y_mid_point_original = zeros(1,4);
y_mid_point_01 = zeros(1,4);
y_mid_point_02 = zeros(1,4);
y_mid_point_03 = zeros(1,4);
y_mid_point_04 = zeros(1,4);

% calculate the y mid point of detection box of each frames.
for i = 1:4
    y_mid_point_original(1,i) = (orginal(i,4) + orginal(i,3))/2;
    y_mid_point_01(1,i) = (group_01(i,4) + group_01(i,3))/2;
    y_mid_point_02(1,i) = (group_02(i,4) + group_02(i,3))/2;
    y_mid_point_03(1,i) = (group_03(i,4) + group_03(i,3))/2;
    y_mid_point_04(1,i) = (group_04(i,4) + group_04(i,3))/2;
end
y_mid_points = cat(1,y_mid_point_original,y_mid_point_01,y_mid_point_02,y_mid_point_03,y_mid_point_04);
...
% x_mid of group(01,02,03,04) - x_mid original
for i = 1:5
...
% y_mid of group(01,02,03,04) - y_mid original
...
% area of group(01,02,03,04) - area original
...
%%
result_path = 'E:\Parkinson\3yp_parkinson\lowquality\cobr\detection_box\result\';
