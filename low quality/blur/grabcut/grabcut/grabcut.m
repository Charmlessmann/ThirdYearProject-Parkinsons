function im_out = grabcut(im_in, gamma,box,scale)
...
[im_1d, alpha, im_sub] = select_back(im_in,box,scale);
...
%%% Initialize GMM
% no_gauss = 3; % 5 Gaussians in each GMM
% Background

k_B = kmeans(T_B,1, 'Distance', 'cityblock', 'Replicates', 5);
gmm_B = fit_gmm(T_B, k_B);
% Foreground
k_U = kmeans(T_U, 1, 'Distance', 'cityblock', 'Replicates', 5);
